...
mypath = "/home/qian/Desktop/projects/iMP/ictcf"
imsize=64
mpsize=32
s = 4 
w = 4
...
if __name__ == '__main__':
    trainset = CovidCTDataset(root_dir='{0}/image'.format(mypath),
                              txt_COVID='{0}/Data-split/pCT/train_pCT.txt'.format(mypath),
                              txt_NonCOVID='{0}/Data-split/nCT/train_nCT.txt'.format(mypath),
                              transform= transformer,stride=s,window=w)
    valset = CovidCTDataset(root_dir='{0}/image'.format(mypath),
                              txt_COVID='{0}/Data-split/pCT/val_pCT.txt'.format(mypath),
                              txt_NonCOVID='{0}/Data-split/nCT/val_nCT.txt'.format(mypath),
                              transform= transformer,stride=s,window=w)
    testset = CovidCTDataset(root_dir='{0}/image'.format(mypath),
                              txt_COVID='{0}/Data-split/pCT/test_pCT.txt'.format(mypath),
                              txt_NonCOVID='{0}/Data-split/nCT/test_nCT.txt'.format(mypath),
                              transform= transformer,stride=s,window=w)
